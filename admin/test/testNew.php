...
if(isset($_POST['btn'])){
  ...
  #sql语句区
	$sql = "INSERT INTO  `ksxt`.`test` (`title` ,`cate` ,`class` ,`startTime` ,`overTime` ,`radio` ,`checkbox` ,`judge` ,`fill` ,`saq`)VALUES ('$title',  '$cate',  '$class',  '$startTime',  '$overTime',  '$radio',  '$checkbox',  '$judge',  '$fill',  '$saq');";
