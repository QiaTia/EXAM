...
<body>
<?php
	include_once '../admin/admin_check.php';
...
<table class="mdui-table">
	...
	<tr>
		...
		<td> 
			<a  onclick="return confirm('确定阅卷吗？')" href="test/testCheck.php?id=<?php echo $info['id'].'&userid='.$info['userid']; ?>" class="mdui-btn mdui-btn-icon mdui-text-color-red"><i class="mdui-icon material-icons">&equiv;</i></a>
		</td>
    </tr>
<?php 
	}
