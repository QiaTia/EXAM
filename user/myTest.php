...
#获取答案
	...
	<title><?php echo $_SESSION['userinfo'].'的&nbsp;'.$testInfo['title'].'试卷';?></title>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:void(0);"><?php echo $_SESSION['userinfo'].'的&nbsp;'.$testInfo['title'].'试卷';?></a>
            </div>
